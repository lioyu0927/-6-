"""
TOUCHLESS WORKSTATION v13.MERGED
─────────────────────────────────────────────────────────────
jw10 (접근성·편의성·아스키 UI·메인메뉴) +
b    (손 트래킹 파라미터 조절·제어 존·스켈레톤·제스처 피드백·
      UIHelper·Glitch·FPS·가이드 오버레이·키보드 단축키·
      BLUES/MAJOR 음계·개선된 오디오 탐색·precision_mode 등)
완전 통합
"""
